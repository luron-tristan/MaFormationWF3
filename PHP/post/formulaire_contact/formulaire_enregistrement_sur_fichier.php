...
if(isset($_POST['pseudo']) && isset($_POST['email']))
{
    ...
    if(!empty($pseudo) && !empty($email))
    {
        ...
        // Fonction fopen
        $f = fopen("liste.txt", "a"); // fopen(nomduficher, mode)
            ...
            <div class="col-sm-6 col-sm-offset-3 well">
                <form action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" name="pseudo" id="pdeudo" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <button class="form-control btn btn-danger"><span class="glyphicon glyphicon-star" style="color: white;"></span><span class="glyphicon glyphicon-star" style="color: white;"></span><span class="glyphicon glyphicon-star" style="color: white;"></span>Valider</button>
                    </div>
                </form>
            </div>
        </div>
