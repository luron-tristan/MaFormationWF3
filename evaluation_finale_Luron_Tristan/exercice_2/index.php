...
if($_POST){
if(!empty($_POST['gender']) && !empty($_POST['firstname']) && !empty($_POST['lastname']) && !empty($_POST['email']) && !empty($_POST['city']) && !empty($_POST['birthdate'])){
...
} elseif(isset($_POST) && empty($_POST['gender']) || empty($_POST['firstname']) || empty($_POST['lastname']) || empty($_POST['email']) || empty($_POST['city']) || empty($_POST['birthdate'])){
...
?>
	...
	<div class="col-md-5">
		...
		<legend>Ajouter un utilisateur</legend>
			...
			<div class="col-md-8">
			<input id="firstname" name="firstname" type="text" class="form-control input-md" value="<?php echo $firstname; ?>" >
				</div>
		</div>
		<div class="form-group">
			<label class="col-md-4 control-label" for="lastname">Nom</label>  
			<div class="col-md-8">
				<input id="lastname" name="lastname" type="text" class="form-control input-md" value="<?php echo $lastname; ?>" >
			</div>
		</div>
		...
		<div class="col-md-8">
		<input id="email" name="email" type="text" class="form-control input-md" value="<?php echo $email; ?>" >
		</div>
		</div>
		...
		<div class="col-md-8">
			<input id="city" name="city" type="text" class="form-control input-md" value="<?php echo $city; ?>" >
		</div>
		</div>
		...
		<div class="col-md-8">
		<input id="birthdate" name="birthdate" type="date" placeholder="JJ-MM-AAAA" class="form-control input-md" value="<?php echo $birthdate; ?>" >
